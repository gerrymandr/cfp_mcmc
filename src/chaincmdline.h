...
struct gengetopt_args_info
{
  ...
  const char *old_style_precincts_file_help; /**< @brief Expect that election results are in precincts file (default no) help description.  */
  ...
  unsigned int old_style_precincts_file_given ;	/**< @brief Whether old_style_precincts_file was given.  */

...
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --old_style_precincts_file\n                                Expect that election results are in precincts \n                                  file (default no)",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->old_style_precincts_file_given = 0 ;
}
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->old_style_precincts_file_help = gengetopt_args_info_full_help[32] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->old_style_precincts_file_given)
    write_into_file(outfile, "old_style_precincts_file", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "test",	0, NULL, 0 },
        { "old_style_precincts_file",	0, NULL, 0 },
        { 0,  0, 0, 0 }
      };
      ...
      switch (c)
        ...
        case 'N':	/* number of districts.  */
          ...
          if (update_arg( (void *)&(args_info->numdists_arg), 
              ...
              &(local_args_info.numdists_given), optarg, 0, "18", ARG_INT,
              check_ambiguity, override, 0, 0,
              "numdists", 'N',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Expect that election results are in precincts file (default no).  */
          else if (strcmp (long_options[option_index].name, "old_style_precincts_file") == 0)
          {
          
          
            if (update_arg( 0 , 
                 0 , &(args_info->old_style_precincts_file_given),
                &(local_args_info.old_style_precincts_file_given), optarg, 0, 0, ARG_NO,
                check_ambiguity, override, 0, 0,
                "old_style_precincts_file", '-',
                additional_error))
              goto failure;
